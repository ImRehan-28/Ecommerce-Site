  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 pt-10 px-4 sm:px-6 lg:px-8">
          {/* Image gallery */}
          ...
          <div className="px-4 sm:px-6 lg:px-0">
            ...
            <div className="mt-4">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    sx={{ color: "#f59e0b" }}
                  />
                  <p className="opacity-50 text-sm">564945 Ratings</p>
              ...
              <form className="mt-10">
                ...
                <Button
                  variant="contained "
                  sx={{ px: "1rem", py: "1rem", bgcolor: "#9155fd" }}
                >
                  Add To Cart
                </Button>
              </form>
              ...
              <Grid item xs={5} className=" ">
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    sx={{ color: "#f59e0b" }}
                  />
                  <p className="text-sm text-gray-500">4748374 Ratings</p>
                </div>
