  ...
  const handleFilter = (value, sectionId) => {
    ...
    if (filterValue) {
      ...
      if (filterArray.includes(value)) {
        // Remove the value
        const newFilterArray = filterArray.filter((item) => item !== value);
        if (newFilterArray.length === 0) {
          searchParams.delete(sectionId);
        } else {
          searchParams.set(sectionId, newFilterArray.join(","));
        }
      } else {
        // Add the value
      ...
      // First time selecting this filter
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                <MenuItems
                  ...
                  className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md
                   bg-white shadow-2xl ring-1 ring-black/5 transition 
              ...
              <div className="text-justify">
                ...
                <form className="hidden lg:block ">
                  {filters.map((section) => (
                    ...
                    >
                      <h3 className="-my-3 flow-root text-red-900" >
                          ...
                          <div className="space-y-4">
                            ...
                            >
                              {section.options.map((option, optionIdx) => (
                                <>
                                  <FormControlLabel
                                    onChange={(e,sectionId)=>handleRadioFilterchange(e,sectionId)}
                                    value={option.value}
                                    control={<Radio />}
                                    label={option.label}
                                  />
